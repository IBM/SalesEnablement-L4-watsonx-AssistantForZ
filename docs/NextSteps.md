...
## Earn the badge
Finally, remember to earn the <a href="https://www.credly.com/org/ibm/badge/ibm-watsonx-assistant-for-z-technical-sales-advance">{{badge.name}}</a> you must complete the {{learningplan.name}} learning plan.
